<?php
function bwge_bwge_spider_featured($current_plugin = '') {
  $plugins = array(
    "form-maker" => array(
      'title'    => 'Form Maker',
    ...
    "gallery-ecommerce" => array(
      'title'    => 'Gallery Ecommerce',
      'text'     => 'WordPress Gallery Ecommerce plugin',
      'content'  => 'Photo Gallery is a fully responsive WordPress Gallery plugin with advanced functionality.',
      'href'     => 'https://web-dorado.com/products/wordpress-photo-gallery-plugin.html'
    ),    
