...
class bwge_Notices {
  protected $prefix = 'bwge';
  protected $plugin_url = WD_BWGE_URL;
  protected $plugin_version = "wd_bwge_version";
  protected $plugin_name = 'Gallery Ecommerce';
  ...
  public function wd_admin_notices() {
    ...
    $notices['two_week_review'] = array(
      ...
      'link' => '<li><span class="dashicons dashicons-external"></span><a href="https://wordpress.org/support/plugin/gallery-ecommerce/reviews/"" target="_blank">' . __('Sure! I\'d love to!', $this->prefix) . '</a></li>
    ...
    $notices['one_week_support'] = array(
      ...
      'link' => '<li><span class="dashicons dashicons-media-text"></span><a target="_blank" href="https://galleryecommerce.com/installation/">' . __('Check out User Guide', $this->prefix) . '</a></li>
                <li><span class="dashicons dashicons-sos"></span><a target="_blank" href="https://web-dorado.com/forum/gallery-ecommerce.html">' . __('Get Some Help', $this->prefix) . '</a></li>
