...
class BWGEFilemanagerController {
    ////////////////////////////////////////////////////////////////////////////////////////
    // Events                                                                             //
    ////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function __construct() {
      ...
      $bwge_options = $this->get_options_data();
      $this->uploads_dir = (($bwge_options->images_directory . '/gallery-ecommerce') ? ABSPATH . $bwge_options->images_directory . '/gallery-ecommerce' : WD_BWGE_DIR . '/filemanager/uploads');
      if (file_exists($this->uploads_dir) == FALSE) {
        mkdir($this->uploads_dir);
      }
      $this->uploads_url = (($bwge_options->images_directory . '/gallery-ecommerce') ? site_url() . '/' . $bwge_options->images_directory . '/gallery-ecommerce' : WD_BWGE_URL . '/filemanager/uploads');
    }
    ...
    public function display() {
      require_once WD_BWGE_DIR . '/filemanager/model.php';
      $model = new BWGEFilemanagerModel($this);

      require_once WD_BWGE_DIR . '/filemanager/view.php';
      $view = new BWGEFilemanagerView($this, $model);
      $view->display();
    }
    ...
    public function make_dir() {
      ...
      $query_url = wp_nonce_url( admin_url('admin-ajax.php'), 'bwge_addImages', 'bwge_nonce' );
      $query_url  = add_query_arg(array('action' => 'bwge_addImages', 'filemanager_msg' => $msg, 'width' => '650', 'height' => '500', 'task' => 'display', 'extensions' => esc_html($_REQUEST['extensions']), 'callback' => esc_html($_REQUEST['callback']), 'dir' => esc_html($_REQUEST['dir']), 'TB_iframe' => '1'), $query_url);
    ...
    public function remove_items() {
      ...
      $_REQUEST['file_names'] = '';
      $query_url = wp_nonce_url( admin_url('admin-ajax.php'), 'bwge_addImages', 'bwge_nonce' );
      $query_url = add_query_arg(array('action' => 'bwge_addImages', 'filemanager_msg' => $msg, 'width' => '650', 'height' => '500', 'task' => 'show_file_manager', 'extensions' => esc_html($_REQUEST['extensions']), 'callback' => esc_html($_REQUEST['callback']), 'dir' => esc_html($_REQUEST['dir']), 'TB_iframe' => '1'), $query_url);      
      header('Location: ' . $query_url);
      exit;
    }
