...
class BWGEFilemanagerView {
    ...
    public function display() {
      ...
      $bwge_options = $this->controller->get_options_data();
      ...
      $icons_dir_url = WD_BWGE_URL . '/filemanager/images/file_icons';
      $sort_icon = $icons_dir_url . '/' . $sort_order;
      wp_print_scripts('jquery');
      wp_print_scripts('jquery-ui-widget');
      wp_print_scripts('wp-pointer');
      ?>
      <script src="<?php echo WD_BWGE_URL; ?>/filemanager/js/jq_uploader/jquery.iframe-transport.js"></script>
      <script src="<?php echo WD_BWGE_URL; ?>/filemanager/js/jq_uploader/jquery.fileupload.js"></script>
      ...
      <script>
        ...
        var errorLoadingFile = "<?php echo __('File loading failed', 'bwge_back'); ?>";

        var warningRemoveItems = "<?php echo __('Are you sure you want to permanently remove selected items?', 'bwge_back'); ?>";
        var warningCancelUploads = "<?php echo __('This will cancel uploads. Continue?', 'bwge_back'); ?>";

        var messageEnterDirName = "<?php echo __('Enter directory name', 'bwge_back'); ?>";
        var messageEnterNewName = "<?php echo __('Enter new name', 'bwge_back'); ?>";
        var messageFilesUploadComplete = "<?php echo __('Processing uploaded files...', 'bwge_back'); ?>";
      ...
      <script src="<?php echo WD_BWGE_URL; ?>/filemanager/js/default.js?ver=<?php echo wd_bwge_version(); ?>"></script>
      <link href="<?php echo WD_BWGE_URL; ?>/filemanager/css/default.css?ver=<?php echo wd_bwge_version(); ?>" type="text/css" rel="stylesheet">
      <link href="<?php echo WD_BWGE_URL; ?>/css/bwge_ecommerce.css?ver=<?php echo wd_bwge_version(); ?>" type="text/css" rel="stylesheet">
    
      <?php
      switch ($items_view) {
        case 'list':
          ?>
          <link href="<?php echo WD_BWGE_URL; ?>/filemanager/css/default_view_list.css?ver=<?php echo wd_bwge_version(); ?>" type="text/css" rel="stylesheet">
          <?php
          break;
        case 'thumbs':
          ?>
          <link href="<?php echo WD_BWGE_URL; ?>/filemanager/css/default_view_thumbs.css?ver=<?php echo wd_bwge_version(); ?>" type="text/css" rel="stylesheet">
          <?php
          break;
      }
      $i = 0;
          ...
          <div id="file_manager">
            <div class="ctrls_bar ctrls_bar_header">
              <div class="ctrls_left">
                <a class="ctrl_bar_btn btn_up" onclick="onBtnUpClick(event, this);" title="<?php echo __('Up', 'bwge_back'); ?>"></a>
                <a class="ctrl_bar_btn btn_make_dir" onclick="onBtnMakeDirClick(event, this);" title="<?php echo __('Make a directory', 'bwge_back'); ?>"></a>
                <a class="ctrl_bar_btn btn_rename_item" onclick="onBtnRenameItemClick(event, this);" title="<?php echo __('Rename item', 'bwge_back'); ?>"></a>
                <span class="ctrl_bar_divider"></span>
                <a class="ctrl_bar_btn btn_copy" onclick="onBtnCopyClick(event, this);" title="<?php echo __('Copy', 'bwge_back'); ?>"></a>
                <a class="ctrl_bar_btn btn_cut" onclick="onBtnCutClick(event, this);" title="<?php echo __('Cut', 'bwge_back'); ?>"></a>
                <a class="ctrl_bar_btn btn_paste" onclick="onBtnPasteClick(event, this);" title="<?php echo __('Paste', 'bwge_back'); ?>"> </a>
                <a class="ctrl_bar_btn btn_remove_items" onclick="onBtnRemoveItemsClick(event, this);" title="<?php echo __('Remove items', 'bwge_back'); ?>"></a>
                <span class="ctrl_bar_divider"></span>
                <span class="ctrl_bar_btn">
                  <a id="upload_images" class="wd-btn wd-btn-primary wd-btn-icon wd-btn-upload" onclick="onBtnShowUploaderClick(event, this);"><?php echo __('Upload files', 'bwge_back'); ?></a>
                </span>
                <?php if ($bwge_options->enable_ML_import) { ?>
                <span class="ctrl_bar_divider"></span>
                <span class="ctrl_bar_btn">
                  <a class="wd-btn wd-btn-primary wd-btn-icon wd-btn-import" onclick="onBtnShowImportClick(event, this);"><?php echo __('Media library', 'bwge_back'); ?></a>
                </span>
                <?php } ?>
              <span class="ctrl_bar_divider"></span>
              ...
              <div class="ctrls_right">
                <a class="ctrl_bar_btn btn_view_thumbs" onclick="onBtnViewThumbsClick(event, this);" title="<?php echo __('View thumbs', 'bwge_back'); ?>"></a>
                <a class="ctrl_bar_btn btn_view_list" onclick="onBtnViewListClick(event, this);" title="<?php echo __('View list', 'bwge_back'); ?>"></a>
              </div>
            </div>
            <div id="path">
              <?php
              foreach ($file_manager_data['path_components'] as $key => $path_component) {
                ?>
                <a <?php echo ($key == 0) ? 'title="'. __("To change upload directory go to Options page.", 'bwge_back').'"' : ''; ?> class="path_component path_dir"
            ...
            <div class="ctrls_bar ctrls_bar_footer">
              <div class="ctrls_left">
                <a class="wd-btn wd-btn-primary btn_open  none_select" onclick="onBtnSelectAllClick();" id="select_all_images"><?php echo __('Select All', 'bwge_back'); ?></a>
              </div>
              <div class="ctrls_right">
                ...
                <a id="add_selectid_img" class="wd-btn wd-btn-primary  btn_open  none_select" onclick="onBtnOpenClick(event, this);" style="display:table-cell;"><?php echo ((isset($_REQUEST['callback']) && esc_html($_REQUEST['callback']) == 'bwge_add_image') ? __('Add selected images to gallery', 'bwge_back') : __('Add', 'bwge_back')); ?></a>
                <span class="ctrl_bar_empty_devider"></span>
                <a class="wd-btn wd-btn-secondary btn_cancel none_select" onclick="onBtnCancelClick(event, this);" style="display:table-cell;"><?php echo 'Cancel'; ?></a>
              </div>
            </div>
          </div>
          <div id="importer" style="display: none;">
            ...
            <div class="ctrls_bar ctrls_bar_header">
              <div class="ctrls_left upload_thumb">
                <?php echo __("Thumbnail Maximum Dimensions:", 'bwge_back'); ?>
                <input type="text" class="upload_thumb_dim" name="importer_thumb_width" id="importer_thumb_width" value="<?php echo $bwge_options->upload_thumb_width; ?>" /> x 
                <input type="text" class="upload_thumb_dim" name="importer_thumb_height" id="importer_thumb_height" value="<?php echo $bwge_options->upload_thumb_height; ?>" /> px
              </div>
              <div class="ctrls_right">
                <a class="ctrl_bar_btn btn_back" onclick="onBtnBackClick(event, this);" title="<?php echo __('Back', 'bwge_back'); ?>"></a>
              </div>
              <div class="ctrls_right_img upload_thumb">
                <?php echo __("Image Maximum Dimensions:", 'bwge_back'); ?>
                <input type="text" class="upload_thumb_dim" name="importer_img_width" id="importer_img_width" value="<?php echo $bwge_options->upload_img_width; ?>" /> x 
                <input type="text" class="upload_thumb_dim" name="importer_img_height" id="importer_img_height" value="<?php echo $bwge_options->upload_img_height; ?>" /> px
              </div>
            </div>
            ...
            <div class="ctrls_bar ctrls_bar_footer">
              <div class="ctrls_left">
                <a class="wd-btn wd-btn-primary btn_open  none_select" onclick="onBtnSelectAllMediLibraryClick();" ><?php echo __('Select All','bwge_back'); ?></a>
              </div>
              <div class="ctrls_right">
                <span id="file_names_span">
                  <span>
                ...
                <a class="wd-btn wd-btn-primary btn_open  none_select" onclick="onBtnImportClick(event, this);"><?php echo __("Import selected images", 'bwge_back'); ?></a>
              </div>
            </div>
          </div>
          <div id="uploader">
            ...
            <div class="ctrls_bar ctrls_bar_header">
              <div class="ctrls_left upload_thumb">
                <?php echo __("Thumbnail Maximum Dimensions:", 'bwge_back'); ?>
                <input type="text" class="upload_thumb_dim" name="upload_thumb_width" id="upload_thumb_width" value="<?php echo $bwge_options->upload_thumb_width; ?>" /> x 
                <input type="text" class="upload_thumb_dim" name="upload_thumb_height" id="upload_thumb_height" value="<?php echo $bwge_options->upload_thumb_height; ?>" /> px
              </div>
              <div class="ctrls_right">
                <a class="ctrl_bar_btn btn_back" onclick="onBtnBackClick(event, this);" title="<?php echo __('Back', 'bwge_back'); ?>"></a>
              </div>
              <div class="ctrls_right_img upload_thumb">
                <?php echo __("Image Maximum Dimensions:", 'bwge_back'); ?>
                <input type="text" class="upload_thumb_dim" name="upload_img_width" id="upload_img_width" value="<?php echo $bwge_options->upload_img_width; ?>" /> x 
                <input type="text" class="upload_thumb_dim" name="upload_img_height" id="upload_img_height" value="<?php echo $bwge_options->upload_img_height; ?>" /> px
              </div>
            </div>
            <label for="jQueryUploader">
              <div id="uploader_hitter">
                <div id="drag_message">
                  <span><?php echo __('Drag files here or click the button below','bwge_back') . '<br />' . __('to upload files','bwge_back')?></span>
                </div>
                <div id="btnBrowseContainer">
                <?php
                $query_url = wp_nonce_url( admin_url('admin-ajax.php'), 'bwge_UploadHandler', 'bwge_nonce' );
                $query_url = add_query_arg(array('action' => 'bwge_UploadHandler', 'dir' => (isset($_REQUEST['dir']) ? esc_html($_REQUEST['dir']) : '') . '/'), $query_url);
            ...
            <div id="uploader_progress">
              ...
              <span id="uploader_progress_text" class="uploader_text">
                <?php echo __('No files to upload', 'bwge_back'); ?>
              </span>
            </div>
          </div>
        </div>
