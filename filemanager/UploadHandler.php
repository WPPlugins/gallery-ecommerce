...
$controller = new BWGEFilemanagerController();

$upload_handler = new BWGEUploadHandler(array(
...
class BWGEUploadHandler {
    ...
    protected function handle_file_import($uploaded_file, $name, $index = null, $content_range = null) {
      ...
      $file_bwge_typearray = explode('.', $name);
      $type = strtolower(end($file_bwge_typearray));
    ...
    protected function send_content_bwge_typeheader() {
    ...
    public function head() {
      ...
      $this->send_content_bwge_typeheader();
    }
    ...
    public function get($print_response = true) {
      if (isset($_GET['import']) && $_GET['import'] == 'true') {
        ...
        $query_url = add_query_arg(array('action' => 'bwge_addImages', 'width' => '650', 'height' => '500', 'task' => 'show_file_manager', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => $_REQUEST['callback'], 'dir' => $_REQUEST['redir'], 'TB_iframe' => '1'), $query_url);
