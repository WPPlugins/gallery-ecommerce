...
class BWGEModelRates_bwge {
  ...
  public function get_rows_data() {
    ...
    $rows = $wpdb->get_results("SELECT t1.*, t2.thumb_url, t2.alt, t2.filetype  FROM " . $wpdb->prefix . "bwge_image_rate as t1 INNER JOIN " . $wpdb->prefix . "bwge_image as t2 on t1.image_id=t2.id " . $where . $order_by . " LIMIT " . $limit . ",".$this->per_page);
    return $rows;
  }
  ...
  public function page_nav() {
    ...
    $where .= ((isset($_POST['search_select_value']) && ((int) $_POST['search_select_value'])) ? ' AND t1.image_id=' . (int) $_POST['search_select_value'] : '');
    $query = "SELECT COUNT(*) FROM " . $wpdb->prefix . "bwge_image_rate as t1 INNER JOIN " . $wpdb->prefix . "bwge_image as t2 on t1.image_id=t2.id " . $where;
