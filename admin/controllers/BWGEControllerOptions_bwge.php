...
class BWGEControllerOptions_bwge {
  ////////////////////////////////////////////////////////////////////////////////////////
  // Events                                                                             //
  ////////////////////////////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////
  ...
  public function execute() {
    ...
    if($task != ''){
      if(!BWGELibrary::verify_nonce('options_bwge')){
  ...
  public function display() {
    require_once WD_BWGE_DIR . "/admin/models/BWGEModelOptions_bwge.php";
    $model = new BWGEModelOptions_bwge();

    require_once WD_BWGE_DIR . "/admin/views/BWGEViewOptions_bwge.php";
    $view = new BWGEViewOptions_bwge($model);
    $view->display();
  }
  ...
  public function save_db() {
    ...
    if (isset($_POST['images_directory'])) {
      ...
      if (!is_dir(ABSPATH . $images_directory)) {
        echo BWGELibrary::message('Uploads directory doesn\'t exist. Old value is restored.', 'error');
    ...
    $ecommerce_icon_show_hover = (isset($_POST['ecommerce_icon_show_hover']) ? esc_html(stripslashes($_POST['ecommerce_icon_show_hover'])) : 'none');
    ...
    $slideshow_ecommerce_icon = (isset($_POST['slideshow_ecommerce_icon']) ? esc_html(stripslashes($_POST['slideshow_ecommerce_icon'])) : 0);
    ...
    $popup_enable_ecommerce = (isset($_POST['popup_enable_ecommerce']) ? esc_html(stripslashes($_POST['popup_enable_ecommerce'])) : 0);
    ...
    $watermark_url = (isset($_POST['watermark_url']) ? esc_html(stripslashes($_POST['watermark_url'])) : WD_BWGE_URL . '/images/watermark.png');
    ...
    $built_in_watermark_url = (isset($_POST['built_in_watermark_url']) ? esc_html(stripslashes($_POST['built_in_watermark_url'])) : WD_BWGE_URL . '/images/watermark.png');
    ...
    $carousel_ecommerce_icon = (isset($_POST['carousel_ecommerce_icon']) ? esc_html(stripslashes($_POST['carousel_ecommerce_icon'])) : 0);  
    ...
    $bwge_permissions = (isset($_POST['permissions']) ? esc_html(stripslashes($_POST['permissions'])) : 'manage_options');
  ...
  $placeholder = (isset($_POST['placeholder']) ? esc_html(stripslashes($_POST['placeholder'])) : '');
    ...
    $save = $wpdb->update($wpdb->prefix . 'bwge_option', array(
      ...
      'ecommerce_icon_show_hover' => $ecommerce_icon_show_hover,
      ...
      'slideshow_ecommerce_icon' => $slideshow_ecommerce_icon,
      ...
      'popup_enable_ecommerce' => $popup_enable_ecommerce,
      ...
      'carousel_ecommerce_icon' => $carousel_ecommerce_icon,
    ...
    if ($save !== FALSE) {      
      if ($old_images_directory && $old_images_directory != $images_directory) {
        rename(ABSPATH . $old_images_directory . '/gallery-ecommerce', ABSPATH . $images_directory . '/gallery-ecommerce');
      }
      if (!is_dir(ABSPATH . $images_directory . '/gallery-ecommerce')) {
        mkdir(ABSPATH . $images_directory . '/gallery-ecommerce', 0777);
      }
    ...
    */
    ...
    remove_filter( 'cron_schedules', 'bwge_add_autoupdate_interval' );
